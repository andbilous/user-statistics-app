      ...
      <Container>
          <Row className="row align-items-center justify-content-between py-5">
            <Col className="col-md-7 col-lg-6">
              <p> Brainstorming for desired perfect Usability
              Our design projects are fresh and simple and will benefit your business greatly. Learn more about our work!</p>
