      ...
      <Container>
        ...
        <Row>
          ...
          <h5>From</h5>
                ...
                <Button size='sm' color='primary' onClick={handleChangeRange}>Set Range</Button>
          </Col>
        </Row>
        <Row className='d-flex justify-content-center'>
          <Col >
              <h5>Clicks</h5>
              <LineChart width={1000} height={300} data={data.stats}>
              ...
              <h5>Views</h5>
              <LineChart width={window.innerWidth-200} height={300} data={data.stats}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="date" />
                <YAxis />
                <Tooltip />
